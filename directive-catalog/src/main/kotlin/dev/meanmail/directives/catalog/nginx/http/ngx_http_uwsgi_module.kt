...
val uwsgiCacheBackgroundUpdate = Directive(
...
val uwsgiCacheRevalidate = Directive(
...
val uwsgiForceRanges = Directive(
...
val uwsgiIgnoreClientAbort = Directive(
...
val uwsgiInterceptErrors = Directive(
    name = "uwsgi_intercept_errors",
...
val uwsgiPassRequestBody = Directive(
...
val uwsgiPassRequestHeaders = Directive(
...
val uwsgiRequestBuffering = Directive(
...
val uwsgiSocketKeepAlive = Directive(
...
val uwsgiSslServerName = Directive(
...
val uwsgiSslSessionReuse = Directive(
...
val uwsgiStoreBuffering = Directive(
...
val uwsgiStoreNoUpdateError = Directive(
