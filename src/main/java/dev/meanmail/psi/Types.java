...
public interface Types {
  ...
  IElementType NAMED_VALUE_STMT = new NginxElementType("NAMED_VALUE_STMT");
  IElementType NAME_STMT = new NginxElementType("NAME_STMT");
  IElementType NUM_MAP_BLOCK_CONTENT = new NginxElementType("NUM_MAP_BLOCK_CONTENT");
  IElementType NUM_MAP_BLOCK_STMT = new NginxElementType("NUM_MAP_BLOCK_STMT");
  IElementType NUM_MAP_DEFAULT_STMT = new NginxElementType("NUM_MAP_DEFAULT_STMT");
  IElementType NUM_MAP_DIRECTIVE_STMT = new NginxElementType("NUM_MAP_DIRECTIVE_STMT");
  IElementType NUM_MAP_INCLUDE_STMT = new NginxElementType("NUM_MAP_INCLUDE_STMT");
  IElementType NUM_MAP_STMT = new NginxElementType("NUM_MAP_STMT");
  IElementType NUM_MAP_VALUE_STMT = new NginxElementType("NUM_MAP_VALUE_STMT");
  IElementType NUM_MAP_VOLATILE_STMT = new NginxElementType("NUM_MAP_VOLATILE_STMT");
  IElementType REGEX_ATOM = new NginxElementType("REGEX_ATOM");
  IElementType REGEX_EXPR = new NginxElementType("REGEX_EXPR");
  IElementType REGEX_GROUP = new NginxElementType("REGEX_GROUP");
  ...
  IElementType TYPES_BLOCK_CONTENT = new NginxElementType("TYPES_BLOCK_CONTENT");
  IElementType TYPES_BLOCK_STMT = new NginxElementType("TYPES_BLOCK_STMT");
  IElementType TYPES_DIRECTIVE_STMT = new NginxElementType("TYPES_DIRECTIVE_STMT");
  IElementType TYPES_INCLUDE_STMT = new NginxElementType("TYPES_INCLUDE_STMT");
  IElementType TYPES_MAPPING_STMT = new NginxElementType("TYPES_MAPPING_STMT");
  IElementType TYPES_STMT = new NginxElementType("TYPES_STMT");
  IElementType VALUE_STMT = new NginxElementType("VALUE_STMT");
  IElementType VARIABLE_STMT = new NginxElementType("VARIABLE_STMT");
  IElementType VAR_STMT = new NginxElementType("VAR_STMT");
