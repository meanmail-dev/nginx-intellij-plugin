...
public interface Types {
  ...
  IElementType RETURN_DIRECTIVE_STMT = new NginxElementType("RETURN_DIRECTIVE_STMT");
  IElementType RETURN_STMT = new NginxElementType("RETURN_STMT");
  ...
  IElementType IP_ADDRESS = new NginxTokenType("IP_ADDRESS");
  IElementType IP_RANGE = new NginxTokenType("IP_RANGE");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == RETURN_DIRECTIVE_STMT) {
        return new ReturnDirectiveStmtImpl(node);
      }
