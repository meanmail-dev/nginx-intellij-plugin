...
public class ConcatenatedExprImpl extends NginxCompositeElementBase implements ConcatenatedExpr {

  public ConcatenatedExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StringStmt> getStringStmtList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StringStmt.class);
  }
