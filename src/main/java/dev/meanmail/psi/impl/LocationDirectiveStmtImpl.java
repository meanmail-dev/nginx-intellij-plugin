...
public class LocationDirectiveStmtImpl extends NginxCompositeElementBase implements LocationDirectiveStmt {

  public LocationDirectiveStmtImpl(ASTNode node) {
    super(node);
  }
