...
public class NamedValueStmtImpl extends NginxCompositeElementBase implements NamedValueStmt {

  public NamedValueStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitNamedValueStmt(this);
  }
