...
public class NumMapValueStmtImpl extends NginxCompositeElementBase implements NumMapValueStmt {

  public NumMapValueStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitNumMapValueStmt(this);
  }
