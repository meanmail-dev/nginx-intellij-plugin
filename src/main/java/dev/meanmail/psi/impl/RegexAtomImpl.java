...
public class RegexAtomImpl extends NginxCompositeElementBase implements RegexAtom {

  public RegexAtomImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitRegexAtom(this);
  }
  ...
  public RegexGroup getRegexGroup() {
    return findChildByClass(RegexGroup.class);
  }
