...
public class VarStmtImpl extends NginxCompositeElementBase implements VarStmt {

  public VarStmtImpl(ASTNode node) {
    super(node);
  }
  ...
  public VariableStmt getVariableStmt() {
    return findNotNullChildByClass(VariableStmt.class);
  }
